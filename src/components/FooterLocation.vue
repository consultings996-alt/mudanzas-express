<script setup>
// Aquí puedes agregar lógica reactiva o enlaces en el futuro si lo necesitas
</script>

<template>
  <footer class="site-footer">
    <!-- Bloque Superior: Ubicación Física y Mapa Embebido -->
    <div class="location-container">
      <div class="map-wrapper">
       <!-- Mapa incrustado corregido con la ruta de Google Maps Embed -->
        <iframe 
    ...
    <!-- Bloque Inferior: Directorio Corporativo sobre Fondo Oscuro -->
...
/* Contenedor del mapa y la dirección */
...
.info-wrapper h2 { font-size: 2.2rem; margin-bottom: 1.5rem; color: #111; line-height: 1.2; }
...
/* Directorio oscuro de cierre */
.directory-container { background-color: var(--color-dark, #0c0c0c); color: #888; padding: 5rem 2rem 2rem 2rem; }
...
.footer-logo { color: #fff; font-size: 1.6rem; margin: 0; letter-spacing: 0.5px; }
...
/* Ajustes adaptativos para celulares */
