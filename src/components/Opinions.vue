<script setup>
// Componente de opiniones independiente
</script>
...
.section-tag-line { color: #c62828; font-size: 0.75rem; font-weight: bold; letter-spacing: 1px; display: block; margin-bottom: 0.8rem; }
...
.big-num { font-size: 3.5rem; font-weight: bold; font-family: 'Times New Roman', serif; display: block; line-height: 1; }
